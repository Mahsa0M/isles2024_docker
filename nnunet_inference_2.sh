...
nnUNetv2_install_pretrained_model_from_zip resources/nnUNetTrainer__nnUNetPlans__3d_fullres_all_clean.zip

#nnUNetv2_predict -i test/input/nnunet_raw/Dataset001_HS/ImagesTs -o resources -d '001' -c 3d_fullres
nnUNetv2_predict -i resources/input -o resources/second_nnunet_result -d '001' -c 3d_fullres